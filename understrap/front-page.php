...
<section>
	<div id="carouselControls" class="container-fluid carousel slide indent justify-content-center" data-ride="carousel">
                ...
                <div class="container-fluid slider">
                    <div class="container">
                        <div class="directions">
							<?php $title_first = get_field( 'slider_title_first' );
							if ( ! empty( $title_first ) ) : ?>
                                <h3 class="pt-2 px-3"><?= $title_first ?></h3>
							<?php endif;
							$title_second = get_field( 'slider_title_second' );
							if ( ! empty( $title_second ) ) : ?>
                                <h2 class="text-uppercase pb-2 px-3"><?= $title_second ?></h2>
							<?php endif; ?>
                            <ul class="row indent">
								<?php
								$args  = array(
                                ...
                                <li class="col-6 d-flex justify-content-center align-items-center">
                                    <a href="<?= get_the_permalink(  13 ) ?>" class="text-uppercase view-btn">
                                        <?= __( 'view More', 'understrap' ); ?>
                                    </a>
                                </li>
                            </ul>
                        </div>
		...
		<a class="carousel-control-prev control-type" href="#carouselControls" role="button" data-slide="prev">
			<span class="icon-left-open-big" aria-hidden="true" aria-label="prev"></span>
		</a>
		<a class="carousel-control-next control-type" href="#carouselControls" role="button" data-slide="next">
			<span class="icon-right-open-big" aria-hidden="true" aria-label="true"></span>
		</a>
	</div>
</section>
<section class="about-us container">
	<div class="row indent">
        <div class="col-12 col-md-7 text-right pb-5 pb-md-0 pr-md-3 pr-lg-5">
			<?php $title_first = get_field( 'home_about_title_first' );
			if ( ! empty( $title_first ) ) : ?>
                <h3 class="text-uppercase"><?= $title_first ?></h3>
			<?php endif;
			$title_second = get_field( 'home_about_title_second' );
			if ( ! empty( $title_second ) ) : ?>
                <h2 class="text-uppercase"><?= $title_second ?></h2>
			<?php endif; ?>
			<?php $home_about_text = get_field( 'home_about_text' );
			if ( ! empty( $home_about_text ) ) : ?>
                <p class="py-2 py-lg-4">
					<?= $home_about_text ?>
                </p>
			<?php endif; ?>
            <a href="<?= get_the_permalink( 11 ) ?>" class="text-uppercase read-btn">
...
<section class="our-steps">
    <div class="container">
	    <?php $title_first = get_field( 'home_step_title_first' );
	    if ( ! empty( $title_first ) ) : ?>
            <h3 class="text-uppercase"><?= $title_first ?></h3>
	    <?php endif;
	    $title_second = get_field( 'home_step_title_second' );
	    if ( ! empty( $title_second ) ) : ?>
            <h2 class="text-uppercase pb-4"><?= $title_second ?></h2>
	    <?php endif;
...
<section class="projects">
	<div class="container">
        <?php $title_first = get_field( 'featured_projects_title_first' );
	    if ( ! empty( $title_first ) ) : ?>
            <h3 class="text-uppercase"><?= $title_first ?></h3>
	    <?php endif;
	    $title_second = get_field( 'featured_projects_title_second' );
	    if ( ! empty( $title_second ) ) : ?>
            <h2 class="text-uppercase pb-4"><?= $title_second ?></h2>
	    <?php endif; ?>
		<div class="row">
...
<section class="happy-clients">
	<div class="container">
		<?php $title_first = get_field( 'clients_title_first' );
		if ( ! empty( $title_first ) ) : ?>
            <h3 class="text-uppercase"><?= $title_first ?></h3>
		<?php endif;
		$title_second = get_field( 'clients_title_second' );
		if ( ! empty( $title_second ) ) : ?>
            <h2 class="text-uppercase pb-4"><?= $title_second ?></h2>
		<?php endif;
		if ( have_rows( 'comment_repeater' ) ): ?>
            <ul>
		...
		<ul class="d-lg-flex justify-content-between align-items-center">
			...
			<li>
				<ul class="d-md-flex justify-content-between align-items-center">
					<li class="d-flex justify-content-center align-items-center my-3 pr-md-5 mr-md-5 item-clients">
                        <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt'] ?>" />
						<div class="pl-4">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-6 blog-tabs">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="pt-3">
			            <?php $title_first = get_field( 'blog_title_first' );
			            if ( ! empty( $title_first ) ) : ?>
                            <h3 class="text-uppercase"><?= $title_first ?></h3>
			            <?php endif;
			            $title_second = get_field( 'blog_title_second' );
			            if ( ! empty( $title_second ) ) : ?>
                            <h2 class="text-uppercase pb-4"><?= $title_second ?></h2>
			            <?php endif; ?>
                    </div>
                    <ul class="d-flex">
                        <li class="pr-3">
                            <button class="top-posts-btn active">
                                <?= __( 'Top posts', 'understrap' ); ?>
                            </button>
                        </li>
                        <li>
                            <button class="all-posts-btn">
                                <?= __( 'Check all post', 'understrap' ); ?>
                            </button>
                        </li>
                    </ul>
                </div>
...
<section class="contact-us">
	<div class="container">
		<?php $title_first = get_field( 'contact_title_first' );
		if ( ! empty( $title_first ) ) : ?>
            <h3 class="text-uppercase"><?= $title_first ?></h3>
		<?php endif;
		$title_second = get_field( 'contact_title_second' );
		if ( ! empty( $title_second ) ) : ?>
            <h2 class="text-uppercase pb-4"><?= $title_second ?></h2>
		<?php endif; ?>
		<address>
