...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Left Subscribe', 'understrap' ),
				'id'            => 'footer-left-subscribe',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="footer-widget">',
				'after_widget'  => '</div><!-- .footer-widget -->',
				'before_title'  => '<h2 class="footer-headline text-uppercase">',
				'after_title'   => '</h2>',
			)
		);
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Right Navigation', 'understrap' ),
				'id'            => 'footer-right-navigation',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="footer-widget">',
				'after_widget'  => '</div><!-- .footer-widget -->',
				'before_title'  => '<h2 class="footer-headline">',
				'after_title'   => '</h2>',
			)
		);
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Right Industry', 'understrap' ),
				'id'            => 'footer-right-industry',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="footer-widget">',
				'after_widget'  => '</div><!-- .footer-widget -->',
				'before_title'  => '<h2 class="footer-headline">',
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Right Follow us', 'understrap' ),
				'id'            => 'footer-right-follow',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="footer-widget">',
				'after_widget'  => '</div><!-- .footer-widget -->',
				'before_title'  => '<h2 class="footer-headline">',
